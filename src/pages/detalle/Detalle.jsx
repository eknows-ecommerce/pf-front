  ...
  const getTipo = () => {
    ...
    return (
      <fieldset>
        ...
        <div className="flex mt-2 space-x-1">{tipos}</div>
      </fieldset>
    )
  }
          ...
          <div className="grid gap-8 lg:items-start lg:grid-cols-4">
                ...
                <div className="p-4 bg-gray-100 border rounded">
                  <p className="text-sm">
                    <span className="block">
                      Texto para posibles descuentos?
                    </span>
            ...
            <div className="lg:col-span-3 prose max-w-none ">
              <div className="m-2 p-8 mx-auto max-w-screen-2xl sm:px-6 lg:px-8 shadow-2xl rounded-2xl bg-orange-50">
                ...
                <p className="font-comforta font-bold text-justify mr-2 ml-2">
                  {libro.resumen}
                </p>
                <br />
              ...
              <div className="m-2 p-8 mx-auto max-w-screen-2xl sm:px-6 lg:px-8 shadow-2xl rounded-2xl bg-orange-50">
                ...
                {reviews && reviews.length > 0 ? (
                  ...
                  <div className="text-center font-comforta font-bold">
                    No hay reviews
                  </div>
                )}
              </div>
