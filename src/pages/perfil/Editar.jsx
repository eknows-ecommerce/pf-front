                            ...
                            <div className="px-4 md:px-10 pt-6 md:pt-12 md:pb-4 pb-7">
                                ...
                                <form  onSubmit={handleSubmit} className="mt-11">
                                    <div className="flex items-center space-x-9">
                                        ...
                                        <input placeholder="Nombre" name="name" value={input.name} onChange={(e)=>handleChange(e)} className="w-1/2 focus:outline-none placeholder-gray-500 py-3 px-3 text-sm leading-none text-gray-800 bg-white border rounded border-gray-200" type="text"/>
                                        <input  placeholder="Telefono" name="telefono" value={input.telefono} type="number" onChange={(e)=>handleChange(e)} className="w-1/2 focus:outline-none placeholder-gray-500 py-3 px-3 text-sm leading-none text-gray-800 bg-white border rounded border-gray-200" />
                                        
                                    </div>
                                    <div className="flex items-center space-x-9 mt-8">

                                        <input  placeholder="Pais" name="pais" type="text" onChange={handleChange} value={input.pais }  className="w-1/2 focus:outline-none placeholder-gray-500 py-3 px-3 text-sm leading-none text-gray-800 bg-white border rounded border-gray-200" />
                                        <input placeholder="Ciudad" name="ciudad"  type="text" onChange={handleChange} value={input.ciudad }  className="w-1/2 focus:outline-none placeholder-gray-500 py-3 px-3 text-sm leading-none text-gray-800 bg-white border rounded border-gray-200" />
                                ...
                                <div className="flex items-center justify-between mt-9">
                                    <button onClick={handleExit} className="px-6 py-3 bg-gray-400 hover:bg-gray-500 shadow rounded text-sm text-white">
                                        Cancel
                                    </button>
                                    <button  onClick={handleSubmit} className="px-6 py-3 bg-indigo-700 hover:bg-opacity-80 shadow rounded text-sm text-white">Guardar Cambios</button>
                                </div>
                            </div>
                        </div>
                    </div>
