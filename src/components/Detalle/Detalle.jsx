...
function ReviewCard({ title, text, author, score }) {
  ...
  return (
    <blockquote className="flex flex-col justify-between h-full p-8 bg-white rounded-3xl shadow-xl
    hover:scale-x-[1.01] hover:scale-y-[1.01]">
      <div>
        ...
        <div className="mt-4">
          <h5 className="text-xl text-center font-bold text-pink-600 sm:text-2xl">
            {title}
          </h5>
      ...
      <footer className="mt-8 text-gray-500 text-right">- {author}</footer>
    </blockquote>
  )
}
        ...
        <div className="grid gap-8 lg:items-start lg:grid-cols-4">
          ...
          <div className="lg:col-span-3">
            <div className="prose max-w-none ">
              ...
              <div className="p-8 mx-auto max-w-screen-2xl sm:px-6 lg:px-8 shadow-2xl rounded-2xl bg-orange-50">
