    ...
    return (
        <div>
            <div className="container flex justify-center mx-auto pt-16">
                <div>
                    <p className="text-gray-500 text-lg text-center font-normal pb-3">El talento detras del talento</p>
                    <h1 className="xl:text-4xl text-xl text-center text-gray-800 font-extrabold pb-6 sm:w-4/6 w-5/6 mx-auto">eKnows Team</h1>
                </div>
            </div>
                    ...
                    <div className="lg:flex md:flex sm:flex items-center xl:justify-between flex-wrap md:justify-around sm:justify-around lg:justify-around">
                        <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
                            <div className="rounded overflow-hidden shadow-md bg-white">
                                ...
                                <div className="px-6 mt-16">
                                    <div className="font-bold text-3xl text-center pb-1">Alberto Zalazar</div>
                                    {/* <p className="text-gray-800 text-sm text-center">Chief Executive Officer</p> */}
                                    <p className="text-center text-gray-600 text-base pt-3 font-normal">FullStack Developer</p>
                        ...
                        <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
                            <div className="rounded overflow-hidden shadow-md bg-white">
                                ...
                                <div className="px-6 mt-16">
                                    <div className="font-bold text-3xl text-center pb-1">Alex</div>
                                    {/* <p className="text-gray-800 text-sm text-center">Product Design Head</p> */}
                                    <p className="text-center text-gray-600 text-base pt-3 font-normal">ullStack Developer</p>
                                    <div className="w-full flex justify-center pt-5 pb-5">
                                        <a href="javascript:void(0)" className="mx-5">
                                            <div>
                                                <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="#718096" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="feather feather-github">
                        ...
                        <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
                            <div className="rounded overflow-hidden shadow-md bg-white">
                                ...
                                <div className="px-6 mt-16">
                                    <div className="font-bold text-3xl text-center pb-1">Facundo</div>
                        ...
                        <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
                            <div className="rounded overflow-hidden shadow-md bg-white">
                                ...
                                <div className="px-6 mt-16">
                                    <div className="font-bold text-3xl text-center pb-1">Ricardo</div>
                        ...
                        <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
                            <div className="rounded overflow-hidden shadow-md bg-white">
                                ...
                                <div className="px-6 mt-16">
                                    <div className="font-bold text-3xl text-center pb-1">Jairo</div>
                                    {/* <p className="text-gray-800 text-sm text-center">Product Design Head</p> */}
                                    <p className="text-center text-gray-600 text-base pt-3 font-normal">ullStack Developer</p>
                                    <div className="w-full flex justify-center pt-5 pb-5">
                                        <a href="javascript:void(0)" className="mx-5">
                        ...
                        <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
                            <div className="rounded overflow-hidden shadow-md bg-white">
                                ...
                                <div className="px-6 mt-16">
                                    <div className="font-bold text-3xl text-center pb-1">Matias</div>
