            ...
            <div className="lg:max-w-[1440px] relative inset-0 md:max-w-[744px] max-w-[375px] mx-auto bg-white lg:px-20 md:px-6 px-4 lg:py-20 md:py-12 py-9">
              <div className="relative">
                <img
                  ...
                  className="w-full object-cover lg:h-[330px] lg:block md:hidden hidden" alt="candadobg"
                />
...
Última fecha de actualización: 21/08/2022

1. INFORMACIÓN DEL SITIO

1.1.La presente Política de Privacidad (en adelante la “Política de Privacidad”) se aplica a la utilización de los datos personales del Usuario, conforme se describe a continuación, del Sitio Web publicado en la URL:https://www.digitalhouse.com/latam (en adelante, el “Sitio”), provista por e-Knows (en adelante, “e-Knows”), cuya función principal consiste en ofrecer al Usuario información relacionada a las capacitaciones que e-Knows provee bajo una metodología innovadora basada en la práctica a través de determinados programas, tales como pero sin limitar, Programación Web Full Stack, Diseño de Experiencia de Usuario (UX); Data Science, Data Analytics, Marketing Digital, entre otros (en adelante, el “Servicio”). En caso de ser necesario, e-Knows podrá complementar esta Política de Privacidad con información y/o términos y condiciones específicos con relación al Servicio.

1.2. El mero acceso al Sitio atribuye la condición de usuario de e-Knows (en adelante el “Usuario” o los “Usuarios”) y expresa la aceptación plena y sin reservas de todas y cada una de las cláusulas de la Política de Privacidad en la versión publicada por e-Knows en el momento mismo en que el Usuario acceda al Sitio o utilice su Servicio. En consecuencia, la Política de Privacidad constituirá un acuerdo válido y obligatorio entre el Usuario y e-Knows con relación a la privacidad. Asimismo, la utilización del Servicio expresa la aceptación plena y sin reservas del Usuario de los Términos y Condiciones de Utilización del Servicio (en adelante, los “Términos y Condiciones”) publicados por e-Knows en https://www.digitalhouse.com/latam/politica-de-privacidad, que se complementan con la Política de Privacidad.
...
1.6. Las disposiciones de la Política de Privacidad se aplicarán a todos los Usuarios de e-Knows, hayan estos ingresado sus Datos Personales o no.
...
2.1. e-Knows será la sociedad responsable del tratamiento de los Datos Personales que el Usuario facilite en el Sitio, o que se recopilen o procesen en el Sitio, por, para o mediante los Servicios, o en relación con ellos.
...
2.2. Para e-Knows la privacidad de los Datos Personales del Usuario es muy importante. En caso que el Usuario tenga alguna duda acerca de la Política de Privacidad, o sobre la utilización del Sitio o el Servicio, deberá ponerse en contacto con e-Knows, en cualquier momento, enviando un correo electrónico a contacto@digitalhouse.com. 

3. RECOLECCIÓN DE INFORMACIÓN DE LOS USUARIOS. 

3.1. e-Knows trata los Datos Personales del Usuario únicamente con el consentimiento expreso que el Usuario le otorga con la aceptación de la presente Política de Privacidad. Asimismo el Usuario acepta que e-Knows pueda recolectar información suya utilizando cookies y tags, así como aquella información proporcionada por el Usuario a través de los formularios del Sitio al registrarse y/o al utilizar el Servicio. En caso que un Usuario del Sitio no desee aceptar estas cookies, podrá configurar su navegador para que le otorgue la opción de aceptar cada cookie y rechazar las que no desee. 

 

3.2. Detallamos a continuación toda la información que e-Knows recolecta:
...
Información recopilada pasivamente: Cuando el Usuario accede al Sitio y/o utiliza el Servicio e-Knows podrá recopilar y almacenar de forma automática ciertos tipos de información, tales como la dirección del protocolo de Internet (IP) de la computadora o dispositivo del Usuario y otra información técnica sobre el uso de la computadora o dispositivo, como el tipo y versión del navegador, la configuración de la zona horaria, y el sistema operativo, ubicaciones geográficas, sesiones de uso, permanencia en el Sitio, frecuencia de uso, [ ]

Información procedente de otras fuentes: Es posible que e-Knows reciba información del Usuario de otras fuentes tales como fuentes públicas, terceros (por ejemplo, agencias de informes del consumidor), [ ]

Información proveniente de cookies, tags y/o cualquier otro método de detección de información automatizada provisto por las herramientas que ofrecen en el Sitio:  La información que recopile e-Knows podrá incluir el comportamiento de navegación, dirección IP, logs, y otros tipos de información. Sin embargo, e-Knows no recolectará información personal identificable de manera directa de ningún Usuario usando cookies o tags o cualquier otro método de detección de información automatizada provisto por las herramientas que ofrece el Sitio.

4. FINALIDAD DE TRATAMIENTO DE LOS DATOS PERSONALES. 

4.1. e-Knows trata la información personal del Usuario para las siguientes finalidades:
...
Enviar información y boletines de noticias sobre la actualidad de e-Knows, su Servicios y eventos vía WhatsApp, teléfono, correo postal, correo electrónico, incluso cuando nuestra relación haya terminado salvo que la persona interesada manifieste lo contrario; 
...
Obtener el diagnóstico de los eventuales problemas de conexión que puedan llegar a existir entre el Sitio de e-Knows y los Usuarios, mejorando la calidad de los Servicios.

5. USO DE LA INFORMACIÓN DE LOS USUARIOS RECOLECTADA.

5.1. e-Knows utilizará y almacenará la información provista por los Usuarios y la recolectada por e-Knows con el fin de proveer el Servicio y sus mejoras a los Usuarios, intentando ajustarse a sus necesidades, por el plazo máximo que establezca la legislación aplicable. 

5.2. e-Knows conservará y utilizará los Datos Personales otorgados por el Usuario durante el período en que este último utilice el Sitio y/o utilice el Servicio con la finalidad de prestar el mejor Servicio. Una vez finalizada la relación entre las Partes, por el motivo que fuere, e-Knows se reserva el derecho de conservar la información hasta finalizar la finalidad de su tratamiento. Posteriormente al plazo mencionado, e-Knows procederá a la destrucción de los Datos Personales.

5.3. e-Knows, podrá enviar a sus Usuarios, notificaciones, noticias y novedades de su interés, además de aquellas que revistan el carácter de notificaciones de índole institucional o legal a los fines de ofrecer sus Servicios, ello, siempre y cuando sea aceptado por el Usuario y aquel no haya ejercido su derecho de opt-out. 

5.4. e-Knows podrá compartir la información con otras empresas de servicios o sitios de internet o similares a los fines de cumplir con la finalidad del Servicio de e-Knows y mejorar su calidad. Generalmente dichas empresas o sitios de internet poseen sus propias políticas de privacidad de datos a los fines de su protección. De todas maneras e-Knows empeñará sus mejores esfuerzos en que la privacidad de la información compartida sea protegida de la mejor manera posible. En los casos que corresponda e-Knows intentará firmar acuerdos expresos en materia de protección de datos y de privacidad de la información. Sin perjuicio de ello, e-Knows no será responsable por los daños provocados por tales empresas y/o sitios de internet en cuanto a su deber de protección, confidencialidad y privacidad de los datos que ellas manejan.

5.5. En lo que respecta al tratamiento de datos personales de ciudadanos de la Unión Europea, e-Knows estará a los principios y obligaciones recogidas en el Reglamento UE 2016/679, del Parlamento Europeo y del Consejo, de 27 de abril de 2016, relativo a la protección de las personas físicas en lo que respecta al tratamiento de datos personales y a la libre circulación de estos datos (RGPD).

 

5.6. e-Knows no venderá, alquilará ni negociará ningún Dato Personal a ningún tercero para fines comerciales. Cualquier persona que hubiera provisto información de contacto personal a través del Sitio de e-Knows, podrá enviar un correo electrónico a contacto@digitalhouse.com a fin de actualizar, borrar y/o corregir su información personal de contacto. e-Knows responderá dicho requerimiento dentro de las 48 (cuarenta y ocho) horas siguientes a la recepción del mismo vía correo electrónico.

5.7. El Sitio de e-Knows podrá contener enlaces a otros sitios de internet que no sean propiedad de e-Knows. En consecuencia, e-Knows no será responsable por el actuar de dichos sitios de internet, a los cuales no se aplicará la presente Política de Privacidad. Recomendamos examinar la política de privacidad detallada en aquellos sitios de internet para entender los procedimientos de recolección de información que utilizan y como protegen sus datos personales.

6. CESIÓN Y TRANSFERENCIA DE LOS DATOS PERSONALES. 

6.1. Únicamente para cumplir con los fines establecidos en la presente Política de Privacidad y a efectos de prestar el Servicio, e-Knows podrá revelar los Datos Personales y/o información personal del Usuario, cuando sea necesario, a las autoridades, los socios de e-Knows y otros terceros, como terceros proveedores de servicios utilizados en relación con el Servicio, por ejemplo para realizar servicios de marketing, publicidad, comunicación, infraestructuras y servicios de TI, para personalizar y mejorar nuestro Servicio, para procesar las transacciones con tarjetas de crédito u otros métodos de pago.  Cuando e-Knows contratare a un proveedor de servicios le proporcionará la información que necesitara para realizar su función específica, que puede incluir Datos Personales y otra información que el Usuario proporcione a través del Sitio. Estos proveedores de servicio están autorizados a utilizar los Datos Personales sólo cuando sea necesario para proporcionar sus servicios.

 

6.2. En algunos casos, como la República Argentina o la República Oriental del Uruguay la información personal puede transferirse fuera del país a países con los mismos o mejores niveles de protección. En caso de que la información personal se transfiera a países con niveles más bajos de protección, e-Knows realizará esas transferencias sujetas a las salvaguardas y medidas de seguridad adecuadas, como las cláusulas estándar de protección de datos adoptadas en los respectivos acuerdos o aprobadas por la autoridad legal aplicable.

 

6.3. A su vez, e-Knows podrá compartir los Datos Personales de los Usuarios con terceros, con el consentimiento previo y expreso del Usuario.
...
(i)     e-Knows podrá transferir los datos personales de los Usuarios del Sitio y los que se generen, en su caso, al utilizar el Sitio y/o el Servicio a entidades situadas en el territorio de la República Argentina, siendo éste, un país declarado por la Comisión Europea de nivel de protección adecuada conforme a su Decisión 2003/490/CE, de 30 de junio de 2003.

(ii)     e-Knows podrá transferir los referidos Datos Personales a otras entidades situadas en terceros países que hayan sido declarados por la Comisión Europea de nivel de protección adecuada o con las que se hayan suscrito acuerdos con las garantías adecuadas impuestas por las autoridades europeas (ejemplo, Cláusulas tipo de protección de datos adoptadas por la Comisión, etc.)

 

7. CONFIDENCIALIDAD Y SEGURIDAD DE LA INFORMACIÓN.

7.1.e-Knows ha adoptado medidas de seguridad razonables para proteger la información de los Usuarios e impedir el acceso no autorizado a sus datos o cualquier modificación, divulgación o destrucción no autorizada de los mismos. La información recolectada por e-Knows, será mantenida de manera estrictamente confidencial. El acceso a los datos personales está restringido a aquellos empleados, contratistas, operadores, y representantes de e-Knows que necesitan conocer tales datos para desempeñar sus funciones y desarrollar o mejorar nuestro Servicio. e-Knows exige a sus proveedores los mismos estándares de confidencialidad. e-Knows no permite el acceso a esta información a terceros ajenos a e-Knows, a excepción de un pedido expreso del Usuario.

7.2. Sin perjuicio de lo expuesto, considerando que internet es un sistema abierto, de acceso público, e-Knows no puede garantizar que terceros no autorizados no puedan eventualmente superar las medidas de seguridad y utilizar la información de los Usuarios en forma indebida. En todo caso, e-Knows mantiene planes de seguridad y de respuesta a incidentes para controlar incidentes relacionados con el acceso no autorizado a la información privada que recopila o almacena.

8. CAMBIOS EN LA ESTRUCTURA CORPORATIVA.

8.1.  e-Knows se reserva el derecho de transferir la información recolectada en caso de venta o fusión de e-Knows, o de una adquisición de los activos principales de e-Knows, o cualquier otra clase de transferencia de e-Knows a otra entidad. En dicho supuesto, e-Knows deberá adoptar las medidas razonables a efectos de asegurar que dicha información sea utilizada de una manera consistente con la Política de Privacidad.
...
9.2. Asimismo, toda vez que los menores de edad pueden no alcanzar a comprender debidamente la Política de Privacidad y sus implicancias, ni decidir válidamente sobre las opciones disponibles a través de sus Servicios, e-Knows insta a todos los padres, madres, tutores o responsables legales, bajo cuya supervisión se encuentren los menores que accedan al Servicio de e-Knows, a participar activa y cuidadosamente en las actividades que el menor realice en internet o través del Sitio, al Servicio on-line que utilicen dichos menores, a la información a la que estos accedan, ya sea cuando dichos menores visiten el Sitio de e-Knows o cualquier otro sitio de terceros, a enseñarles y a guiarlos en cómo proteger su propia información personal mientras estén navegando en internet.

10. DERECHOS DE LOS USUARIOS SOBRE LA INFORMACIÓN.

10.1. . e-Knows tratará, por todos los medios a su alcance, de facilitar a los Usuarios sobre los cuales haya recopilado o almacenado información personal, el acceso a sus Datos Personales (“Derecho de Acceso”), así como la rectificación, modificación o actualización de los mismos (“Derecho de Rectificación”), o incluso la cancelación de dichos datos personales (“Derecho de Remoción”), a menos que e-Knows pueda denegar dichas solicitudes (en adelante, las “Solicitudes”), en caso que se encuentre obligada o tenga derecho a conservar dichos Datos de acuerdo a la legislación aplicable.

a) A dichos efectos, el Usuario deberá enviar su Solicitud mediante el envío de un correo electrónico con el asunto “Acceso a Datos Personales” a contacto@digitalhouse.com e-Knows podrá requerir a dicho Usuario que se identifique, lo que podrá ser verificado por e-Knows, así como que precise los Datos Personales a los cuales se desea acceder, rectificar o remover.

b) e-Knows podrá rechazar la tramitación de Solicitudes que sean irrazonablemente repetitivas o sistemáticas, que requieran un esfuerzo técnico desproporcionado, que pongan en peligro la privacidad de los demás Usuarios, o que se consideren poco prácticas, o para las que no sea necesario acceder a los Datos Personales.

c) El servicio de acceso, rectificación y remoción de Datos Personales será prestado por e-Knows en forma gratuita, excepto en caso que requiriera un esfuerzo desproporcionado o irrazonable, en cuyo caso podrá cobrarse un cargo de administración.

10.2. Asimismo, el Usuario autoriza a e-Knows a utilizar sus Datos Personales para el envío de comunicaciones y materiales publicitarios (tales como newsletters y folletos) referentes a las actividades de e-Knows y/o que a exclusivo criterio de esta última pudieran llegar a ser de interés para los Usuarios. Los Usuarios podrán solicitar en cualquier momento la suspensión de dichos envíos.

10.3. A fin de ejercer sus derechos, los Usuarios podrán enviar una solicitud a la casilla de correo contacto@digitalhouse.com.
...
10.5. En lo que respecta a los Usuarios que sean ciudadanos de la Unión Europea, éstos podrán ejercer los siguientes derechos frente a e-Knows:
...
·    Portabilidad. Tiene derecho a recibir aquellos Datos Personales que nos hubiera facilitado, en un formato estructurado, de uso común y lectura mecánica, y a que se los transmitamos a otro responsable del tratamiento distinto de e-Knows.

 

Para ejercer cualquiera de ellos deberá proceder al envío de una correo electrónico a e-Knows a la siguiente dirección contacto@digitalhouse.com en el que adjunte una copia de su documento de identidad o Pasaporte. 
...
11.1. No obstante cualquier otra provisión en contrario en la Política de Privacidad, e-Knows podrá divulgar cierta información personal de los Usuarios, cuando crea de buena fe que esa divulgación resulte razonablemente necesaria para:
...
12.2. Dicho servicio será brindado por un tercero a los fines de obtener la mayor precisión y objetividad posible. Ello significa que quien tratará los datos personales y/o información brindada por el Usuario una vez que realice una denuncia a través de los Canales de Comunicación detallados posteriormente, serán dichos terceros por cuenta y orden de e-Knows. El Usuario entiende y acepta que para los fines de utilizar el Canal de Comunicación, quienes tratarán los datos serán dichos terceros, solo a los efectos de realizar las denuncias y promover un clima ético y de compliance. e-Knows tratará la presente información denunciada y la remitirá a un Comité, el cual analizará las implicancias de la información y las medidas a tomar.

12.3. En razón de lo expuesto, e-Knows pondrá a disposición de los Usuarios los siguientes Canales de Comunicación:

Web Site

www.resguarda.com/eknows
...
13.1. e-Knows podrá modificar la Política de Privacidad en cualquier momento. Las nuevas versiones de la Política de Privacidad serán notificadas mediante publicación de dicha nueva versión en https://e-knows.herokuapp.com/politica-de-privacidad y notificada por las vías de contacto que el Usuario declare en su caso.

13.2. El Usuario acepta que será dado por notificado de cualquier modificación a la Política de Privacidad una vez que e-Knows hubiera publicado las mismas en  https://e-knows.herokuapp.com/politica-de-privacidad, y enviado a la notificación por las vías de contacto declaradas por el Usuario. La aprobación de dicha nueva versión , y que la continuación del Usuario en el uso del Servicio una vez publicada la misma dicha nueva versión se considerará como aceptación de dichas modificaciones a la Política de Privacidad. Sin perjuicio de lo mencionado, el Usuario acepta chequear  https://e-knows.herokuapp.com/politica-de-privacidad/ periódicamente.

14.1. En caso que el Usuario tenga alguna duda acerca de la Política de Privacidad, o sobre la aplicación de la misma, deberá ponerse en contacto con e-Knows, en cualquier momento, vía correo electrónico a contacto@eknows.com
                     </h1>
                 </div>
            </div>
          </div>
